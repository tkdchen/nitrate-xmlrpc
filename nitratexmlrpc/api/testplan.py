...
from nitrate.apps.testplans.models import TestPlan, TestPlanType
from nitrate.apps.testcases.models import TestCasePlan
...
def import_case_via_XML(request, plan_id, values):
    ...
    """
    from nitrate.apps.testplans.models import TestPlan
    from nitrate.apps.testcases.models import TestCase, TestCasePlan, \
            TestCaseCategory
...
def clean_xml_file(xml_file):
    ...
    from nitrate.core.lib.xml2dict.xml2dict import XML2Dict
