...
from nitrate.apps.testruns.models import TestCaseRun, TestCaseRunStatus
from utils import pre_process_ids
from nitrate.core.utils.xmlrpc import XMLRPCSerializer
from nitrate.core.contrib.linkreference.models import create_link, LinkReference
...
def attach_bug(request, values):
    ...
    Params:     $values - Array/Hash: A reference to a hash or array of hashes with keys and values
      ...
      | bug_system_id     | Integer        | Required  | ID of Bug system       |
...
def filter_count(request, values = {}):
    ...
    """
    from nitrate.apps.testruns.models import TestCaseRun
...
def get_completion_time(request, case_run_id):
    ...
    """
    from nitrate.core.forms.widgets import SECONDS_PER_DAY
