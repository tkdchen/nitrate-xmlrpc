...
from nitrate.apps.management.models import TestTag
...
def add_component(request, case_ids, component_ids):
    ...
    >>> TestCase.add_component('56789, 12345', '1234, 5678')
    """
    from nitrate.apps.management.models import Component
...
def attach_bug(request, values):
    ...
    Params:     $values - Array/Hash: A reference to a hash or array of hashes with keys and values
      ...
      | bug_system_id     | Integer        | Required  | ID of Bug system, default 1.  |
    ...
    """
    from nitrate.apps.testcases.models import TestCaseBugSystem
...
def check_case_status(request, name):
    ...
    """
    from nitrate.apps.testcases.models import TestCaseStatus
...
def check_priority(request, value):
    ...
    """
    from nitrate.apps.management.models import Priority
...
def calculate_average_estimated_time(request, case_ids):
    ...
    from nitrate.core.utils.xmlrpc import SECONDS_PER_DAY
...
def get_bugs(request, case_ids):
    ...
    >>> TestCase.get_bugs('12456, 23456')
    """
    from nitrate.apps.testcases.models import TestCaseBug
